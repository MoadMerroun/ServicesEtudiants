 ...
 * @author Surface Pro
 */
public class Attestation_inscription_historique extends javax.swing.JFrame {
    Connection conn = ConnexionBD.connecterbd();
    PreparedStatement ps = null;
    ResultSet rs= null;
    ResultSetMetaData Rss = null;
    /**
     * Creates new form Attestation_inscription_historique
     */
    public Attestation_inscription_historique() {
        initComponents();
    ...
    public void UPdate_table(){
        int c;
        String login="SELECT Attestation_inscription_historique.Nom, Attestation_inscription_historique.Prenom, DateNaissance, LieuNaissance, CIN, CodeEtudiant, Attestation_inscription_historique.Apoge, Attestation_inscription_historique.AnneeDebut,etudiants.EmailInstitutionnel, Statut FROM Attestation_inscription_historique inner join etudiants on Attestation_inscription_historique.Apoge=etudiants.Apoge";
        try {
    ...
    public void UPdate_table_accepte(){
        int c;
        String login="SELECT Attestation_inscription_historique.Nom, Attestation_inscription_historique.Prenom, DateNaissance, LieuNaissance, CIN, CodeEtudiant, Attestation_inscription_historique.Apoge, Attestation_inscription_historique.AnneeDebut,etudiants.EmailInstitutionnel, Statut FROM Attestation_inscription_historique inner join etudiants on Attestation_inscription_historique.Apoge=etudiants.Apoge WHERE Statut='Acceptée'";
        try {
            ps=conn.prepareStatement(login);
            rs=ps.executeQuery();
            Rss = rs.getMetaData();
    ...
    public void UPdate_table_refuse(){
        int c;
        String login="SELECT Attestation_inscription_historique.Nom, Attestation_inscription_historique.Prenom, DateNaissance, LieuNaissance, CIN, CodeEtudiant, Attestation_inscription_historique.Apoge, Attestation_inscription_historique.AnneeDebut,etudiants.EmailInstitutionnel, Statut FROM Attestation_inscription_historique inner join etudiants on Attestation_inscription_historique.Apoge=etudiants.Apoge WHERE Statut='Refusée'";
        try {
            ps=conn.prepareStatement(login);
            rs=ps.executeQuery();
            Rss = rs.getMetaData();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Historique d'attestation d’inscription");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nom","Prenom","DateNaissance","LieuNaissance","CIN","CodeEtudiant","Apoge","AnneeDebut","EmailInstitutionnel","Statut"
            }
        )
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Attestation_inscription_historique.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
