...
public class Attestation_inscription extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Attestation d’inscription");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Attestation_inscription.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
