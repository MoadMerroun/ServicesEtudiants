 ...
 * @author Surface Pro
 */
public class Attestation_scolarite_historique extends javax.swing.JFrame {
    Connection conn = ConnexionBD.connecterbd();
    PreparedStatement ps = null;
    ResultSet rs= null;
    ResultSetMetaData Rss = null;
    /**
     * Creates new form Attestation_scolarite_historique
     */
    public Attestation_scolarite_historique() {
        initComponents();
    ...
    public void UPdate_table(){
        int c;
        String login="SELECT attestationscolarite_historique.Prenom, attestationscolarite_historique.Nom, attestationscolarite_historique.CIN, attestationscolarite_historique.CodeEtudiant, etudiants.DateNaissance, attestationscolarite_historique.LieuNaissance, attestationscolarite_historique.Filiere, etudiants.EmailInstitutionnel, attestationscolarite_historique.Apoge, Statut FROM attestationscolarite_historique inner join etudiants on attestationscolarite_historique.Apoge=etudiants.Apoge";
        try {
    ...
    public void UPdate_table_accepte(){
        int c;
        String login="SELECT attestationscolarite_historique.Prenom, attestationscolarite_historique.Nom, attestationscolarite_historique.CIN, attestationscolarite_historique.CodeEtudiant, etudiants.DateNaissance, attestationscolarite_historique.LieuNaissance, attestationscolarite_historique.Filiere, etudiants.EmailInstitutionnel, attestationscolarite_historique.Apoge, Statut FROM attestationscolarite_historique inner join etudiants on attestationscolarite_historique.Apoge=etudiants.Apoge WHERE Statut='Acceptée'";
        try {
            ps=conn.prepareStatement(login);
            rs=ps.executeQuery();
            Rss = rs.getMetaData();
    ...
    public void UPdate_table_refuse(){
        int c;
        String login="SELECT attestationscolarite_historique.Prenom, attestationscolarite_historique.Nom, attestationscolarite_historique.CIN, attestationscolarite_historique.CodeEtudiant, etudiants.DateNaissance, attestationscolarite_historique.LieuNaissance, attestationscolarite_historique.Filiere, etudiants.EmailInstitutionnel, attestationscolarite_historique.Apoge, Statut FROM attestationscolarite_historique inner join etudiants on attestationscolarite_historique.Apoge=etudiants.Apoge WHERE Statut='Refusée'";
        try {
            ps=conn.prepareStatement(login);
            rs=ps.executeQuery();
            Rss = rs.getMetaData();
    ...
    private void initComponents() {
        ...
        jLabel12.setForeground(new java.awt.Color(211, 222, 234));
        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel12.setText("Historique d'attestation de scolarité");
        ...
        jTable4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Prenom","Nom", "CIN", "CodeEtudiant", "DateNaissance", "LieuNaissance", "Filiere", "EmailInstitutionnel","Apoge", "Statut"
            }
        )
        {
    ...
    jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tous", "Acceptés", "Refusés" }));
    ...
    jPanel6Layout.setHorizontalGroup(
        ...
        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
            .addContainerGap()
            .addComponent(jScrollPane4, javax.swing.GroupLayout.DEFAULT_SIZE, 1147, Short.MAX_VALUE))
    );
    ...
    jLabel13.setForeground(new java.awt.Color(81, 69, 199));
    ...
    jLabel20.setIcon(new javax.swing.ImageIcon("C:\\Users\\Surface Pro\\Documents\\NetBeansProjects\\ServicesEtudiants\\src\\main\\resources\\images\\document (2).png")); // NOI18N

    jLabel21.setIcon(new javax.swing.ImageIcon("C:\\Users\\Surface Pro\\Documents\\NetBeansProjects\\ServicesEtudiants\\src\\main\\resources\\images\\home.png")); // NOI18N
    ...
    private void jComboBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox3ActionPerformed
        String choix = jComboBox3.getSelectedItem().toString();
        switch (choix) {
            case "Tous":
            UPdate_table();
            break;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Attestation_scolarite_historique.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
