 ...
 * @author Surface Pro
 */
public class Attestation_reussite_historique extends javax.swing.JFrame {
    Connection conn = ConnexionBD.connecterbd();
    PreparedStatement ps = null;
    ResultSet rs= null;
    ResultSetMetaData Rss = null;
    /**
     * Creates new form Attestation_reussite_historique
     */
    public Attestation_reussite_historique() {
        initComponents();
    ...
    public void UPdate_table(){
        int c;
        String login="SELECT attestationreussite_historique.Nom, attestationreussite_historique.Prenom, attestationreussite_historique.DateNaissance, attestationreussite_historique.LieuNaissance,  attestationreussite_historique.Filiere , attestationreussite_historique.AnneeAttestation, attestationreussite_historique.Apoge, etudiants.EmailInstitutionnel, Statut FROM attestationreussite_historique inner join etudiants on attestationreussite_historique.Apoge=etudiants.Apoge";
        try {
            ...
            while(rs.next()){
                ...
                for(int i=1;i<=c;i++){
                    ...
                    v2.add(rs.getString("Filiere"));//4
                    v2.add(rs.getString("AnneeAttestation"));//5
                    v2.add(rs.getString("Apoge"));//6
                    v2.add(rs.getString("EmailInstitutionnel"));//7
                    v2.add(rs.getString("Statut"));//8
                }
                Df.addRow(v2);
    ...
    public void UPdate_table_accepte(){
        int c;
        String login="SELECT attestationreussite_historique.Nom, attestationreussite_historique.Prenom, attestationreussite_historique.DateNaissance, attestationreussite_historique.LieuNaissance,  attestationreussite_historique.Filiere , attestationreussite_historique.AnneeAttestation, attestationreussite_historique.Apoge, etudiants.EmailInstitutionnel, Statut FROM attestationreussite_historique inner join etudiants on attestationreussite_historique.Apoge=etudiants.Apoge WHERE Statut='Acceptée'";
        try {
            ps=conn.prepareStatement(login);
            rs=ps.executeQuery();
            Rss = rs.getMetaData();
    ...
    public void UPdate_table_refuse(){
        int c;
        String login="SELECT attestationreussite_historique.Nom, attestationreussite_historique.Prenom, attestationreussite_historique.DateNaissance, attestationreussite_historique.LieuNaissance,  attestationreussite_historique.Filiere , attestationreussite_historique.AnneeAttestation, attestationreussite_historique.Apoge, etudiants.EmailInstitutionnel, Statut FROM attestationreussite_historique inner join etudiants on attestationreussite_historique.Apoge=etudiants.Apoge WHERE Statut='Refusée'";
        try {
            ps=conn.prepareStatement(login);
            rs=ps.executeQuery();
            Rss = rs.getMetaData();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nom", "Prenom", "DateNaissance", "LieuNaissance", "Filiere", "AnneeAttestation", "Apoge", "EmailInstitutionnel","Statut"
            }
        )
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Attestation_reussite_historique.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
