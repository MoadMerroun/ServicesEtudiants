 ...
 * @author Surface Pro
 */
public class Convention_stage_historique extends javax.swing.JFrame {
    Connection conn = ConnexionBD.connecterbd();
    PreparedStatement ps = null;
    ResultSet rs= null;
    ResultSetMetaData Rss = null;
    /**
     * Creates new form Convention_stage_historique
     */
    public Convention_stage_historique() {
        initComponents();
    ...
    public void UPdate_table(){
        int c;
        String login="SELECT Tel, StartDate, EndDate, convention_stage_historique.Apoge, convention_stage_historique.Nom, convention_stage_historique.Prenom, convention_stage_historique.Filiere, RaisonSociale, Addresse, EmailEntreprise, NomEncadrant, etudiants.EmailInstitutionnel, Statut FROM convention_stage_historique inner join etudiants on etudiants.Apoge=convention_stage_historique.Apoge";
        try {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Historique de convention de stage");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tel", "StartDate", "EndDate", "Apoge", "Nom", "Prenom", "Filiere", "RaisonSociale", "Addresse", "EmailEntreprise", "NomEncadrant","EmailInstitutionnel", "Statut"
            }
        )
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Convention_stage_historique.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
