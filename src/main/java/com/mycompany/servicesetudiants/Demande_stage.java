 ...
 * @author Surface Pro
 */
public class Demande_stage extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Demande_stage
     */
    ...
    public void UPdate_table(){
        int c;
        String login="SELECT TypeStage, DebutStage, FinStage, NomEntreprise, etudiants.Apoge, etudiants.Nom, etudiants.Prenom, etudiants.Filiere, etudiants.EmailInstitutionnel FROM stage inner join etudiants on stage.Apoge=etudiants.Apoge";
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Demande_stage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
