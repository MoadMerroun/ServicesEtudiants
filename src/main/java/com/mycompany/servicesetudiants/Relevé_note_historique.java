 ...
 * @author Surface Pro
 */
public class Relevé_note_historique extends javax.swing.JFrame {
    Connection conn = ConnexionBD.connecterbd();
    PreparedStatement ps = null;
    ResultSet rs= null;
    ResultSetMetaData Rss = null;
    /**
     * Creates new form Relevé_note_historique
     */
    public Relevé_note_historique() {
        initComponents();
    ...
    public void UPdate_table(){
        int c;
        String login="SELECT relevenotes_historique.Nom, relevenotes_historique.Prenom, relevenotes_historique.Apoge, relevenotes_historique.CodeEtudiant, relevenotes_historique.AnneeDebut, relevenotes_historique.AdresseEtudiant, relevenotes_historique.AnneeNotes, etudiants.EmailInstitutionnel, relevenotes_historique.Statut FROM relevenotes_historique inner join etudiants on etudiants.Apoge=relevenotes_historique.Apoge";
        try {
    ...
    public void UPdate_table_accepte(){
        int c;
        String login="SELECT relevenotes_historique.Nom, relevenotes_historique.Prenom, relevenotes_historique.Apoge, relevenotes_historique.CodeEtudiant, relevenotes_historique.AnneeDebut, relevenotes_historique.AdresseEtudiant, relevenotes_historique.AnneeNotes, etudiants.EmailInstitutionnel, relevenotes_historique.Statut FROM relevenotes_historique inner join etudiants on etudiants.Apoge=relevenotes_historique.Apoge WHERE Statut='Acceptée'";
        try {
            ps=conn.prepareStatement(login);
            rs=ps.executeQuery();
            Rss = rs.getMetaData();
    ...
    public void UPdate_table_refuse(){
        int c;
        String login="SELECT relevenotes_historique.Nom, relevenotes_historique.Prenom, relevenotes_historique.Apoge, relevenotes_historique.CodeEtudiant, relevenotes_historique.AnneeDebut, relevenotes_historique.AdresseEtudiant, relevenotes_historique.AnneeNotes, etudiants.EmailInstitutionnel, relevenotes_historique.Statut FROM relevenotes_historique inner join etudiants on etudiants.Apoge=relevenotes_historique.Apoge WHERE Statut='Refusée'";
        try {
            ps=conn.prepareStatement(login);
            rs=ps.executeQuery();
            Rss = rs.getMetaData();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Historique de relevé de note");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nom", "Prenom", "Apoge", "CodeEtudiant", "AnneeDebut", "AdresseEtudiant", "AnneeNotes", "EmailInstitutionnel", "Statut"
            }
        )
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Relevé_note_historique.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
